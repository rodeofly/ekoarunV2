...
(function() {
  ...
  megateuf = function() {
    ...
    return $("ul.operateur").each(function() {
      ...
      $("" + op.id + " > ul.operateur").droppable({
        ...
        drop: function(event, ui) {
          var m, m2, m3, match2, match3, op2, op3, str2, str3;
          console.log("webeet1");
          ...
          if (ui.draggable.is("ul")) {
            ...
            switch (op3.type) {
              case "multiplication":
                ...
                if ((match2 != null) && (match3 != null) && (match2.length === 3) && (match3.length === 3)) {
    ...
    create_equation_membre = function() {
      ...
      return $(operateur.id).find("ul").each(function() {
        ...
        for (j = _k = 1; 1 <= factor_length ? _k <= factor_length : _k >= factor_length; j = 1 <= factor_length ? ++_k : --_k) {
          m = new Monome();
          _results.push(m.randomize((alphabet.shuffle())[j], 1).insert(op.id));
        }
        return _results;
      });
    };
  ...
  $(function() {
    ...
    return $('body').on("click", ".panel_touch", function() {
